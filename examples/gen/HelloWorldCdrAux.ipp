        ...
        const HelloWorld& data)
{
    ...
    scdr
        << eprosima::fastcdr::MemberId(0x00000000) << data.keyId()
        << eprosima::fastcdr::MemberId(0x00000001) << data.index()
        << eprosima::fastcdr::MemberId(0x00000002) << data.message()
;
