...
public:
    Topic(const dds::domain::DomainParticipant& dp,
            ...
            trittsv::dds::topic::TopicListener<T>* listener,
            const dds::core::status::StatusMask& mask) {

        //trittsv::dds::topic::register_type_name<T>::register_type(dp.m_pariticpant); // second registering will have no effect, but will not issue any error.
